...
#include "../lib_table_rbtree/table_rbtree.h"
...
TEST(TestTableRBTreeLib, table_rbtree_default_constructor) {
    TableRBTree<std::string, Polynom> table;
    EXPECT_TRUE(table.is_empty());
    EXPECT_EQ(0, table.size());
}

TEST(TestTableRBTreeLib, table_rbtree_copy_constructor) {
    std::string name1 = "p1";
    ...
    TableRBTree<std::string, Polynom> table1;
    table1.insert(name1, data1);
    table1.insert(name2, data2);
    table1.insert(name3, data3);

    TableRBTree<std::string, Polynom> table2(table1);
...
TEST(TestTableRBTreeLib, table_rbtree_operator_assign_self_copy) {
    std::string name1 = "p1";
...
TEST(TestTableRBTreeLib, table_rbtree_insert) {
    TableRBTree<std::string, Polynom> table;
...
TEST(TestTableRBTreeLib, table_rbtree_insert_with_exception) {
    TableRBTree<std::string, Polynom> table;
...
TEST(TestTableRBTreeLib, table_rbtree_find) {
    TableRBTree<std::string, Polynom> table;
...
TEST(TestTableRBTreeLib, table_rbtree_find_with_exception) {
    TableRBTree<std::string, Polynom> table;
...
TEST(TestTableRBTreeLib, table_rbtree_const_find) {
    TableRBTree<std::string, Polynom> table;
    Polynom p("x + y");
    table.insert("key", p);
...
TEST(TestTableRBTreeLib, table_rbtree_erase) {
    TableRBTree<std::string, Polynom> table;
...
TEST(TestTableRBTreeLib, table_rbtree_erase_with_exception) {
    TableRBTree<std::string, Polynom> table;
...
TEST(TestTableRBTreeLib, table_rbtree_is_empty) {
    TableRBTree<std::string, Polynom> table;
    EXPECT_TRUE(table.is_empty());
...
TEST(TestTableRBTreeLib, table_rbtree_size) {
    TableRBTree<std::string, Polynom> table;
    EXPECT_EQ(0, table.size());
...
TEST(TestTableRBTreeLib, table_rbtree_various_polynoms) {
    TableRBTree<std::string, Polynom> table;
...
TEST(TestTableRBTreeLib, table_rbtree_print) {
    TableRBTree<std::string, Polynom> table;
    Polynom p1("x^2");
    Polynom p2("x^3");
    Polynom p3("x^4");
    ...
    std::stringstream s;
    table.print(s);
    EXPECT_EQ(s.str(), "Sorted table on RB tree\n\
  1 : x^3\n\
  4 : x^4\n\
  7 : x^2\n\
  8 : x^3\n\
